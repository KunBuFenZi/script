...
#   Github: https://dl.kbfz.top/proxy/https://github.com/naiba/nezha
#========================================================
...
pre_check() {
    ...
    if [[ -n "${CUSTOM_MIRROR}" ]]; then
        ...
        if [[ -z "${CN}" ]]; then
            GITHUB_RAW_URL="dl.kbfz.top/proxy/https://raw.githubusercontent.com/naiba/nezha/master"
            GITHUB_URL="dl.kbfz.top/proxy/https://github.com"
            Get_Docker_URL="get.docker.com"
            Get_Docker_Argu=" "
...
modify_dashboard_config() {
    ...
    echo "关于 GitHub Oauth2 应用：在 https://dl.kbfz.top/proxy/https://github.com/settings/developers 创建，无需审核，Callback 填 http(s)://域名或IP/oauth2/callback" &&
...
show_menu() {
    ...
    --- https://dl.kbfz.top/proxy/https://github.com/naiba/nezha ---
    ${green}1.${plain}  安装面板端
